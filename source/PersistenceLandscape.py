...
class PersistenceLandscape(ABC):
    ...
    This is the base persistence landscape class and should not be called directly. The subclasses ￿PersistenceLandscapeGrid￿ or ￿PersistenceLandscapeExact￿ should instead be called. Parameters
    ----------
    dgms: list[list]
